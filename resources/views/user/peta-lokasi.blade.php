<x-layout-user :title="'Map'" :isSidebar="true" :js="'resources/js/user/peta-lokasi.js'">
    ...
    <section class="container-fluid bg-abu py-4">
        ...
        <div class="bg-kartu rounded-4 shadow-kartu p-3">
            ...
            {{-- EMBED untuk sekarang sebagai tampilan dahulu  star --}}
            ...
            {{-- di sini render map dengan javascript --}}
            {{-- <div class="map-render">

            </div>
            <input type="hidden" id="user-lokasi" value="{{ $lokasi_user }}"> --}}


            <div class="mt-3 small text-muted text-center">
                <i class="bi bi-layers me-1"></i>
                Direcomendasikan Buka google map direction langsung untuk pengalaman terbaik
